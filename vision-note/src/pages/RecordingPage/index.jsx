...
const RecordingPage = () => {
  ...
  return (
    <div>
      ...
      <p>
        <button onClick = {onStart} disabled = {start}>녹화 시작</button>&nbsp;
        <button onClick = {onPause} disabled = {stop}>녹화 일시정지</button>
        <button onClick = {onRestart} disabled = {restart}>녹화 재시작</button>&nbsp;
        <button onClick = {onStop} disabled = {stop}>녹화 정지</button>
      </p>

      <p>
        <button onClick = {onDownload} disabled = {download}>다운로드</button>
      </p>
